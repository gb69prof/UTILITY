...
Con Node.js 24: `npm run build` genera la cache con versione derivata dai file; `npm test` controlla struttura, date, relazioni, mappa PWA e disposizione delle fasce. La pagina `tests/browser.html` esegue 30 controlli integrati nel browser, inclusa l'apertura di tutte le schede e il precaricamento offline.
