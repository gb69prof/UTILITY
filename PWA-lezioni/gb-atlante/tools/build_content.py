...
S=[
 ...
 ('SRC_RUSSIA_RETREAT','Fondation Napoléon','Napoleon’s Russian campaign: The retreat from Moscow',base+'en/history-of-the-two-empires/timelines/napoleons-russian-campaign-the-retreat-from-moscow/','modern','scholarly_chronology','reference_only','high'),
